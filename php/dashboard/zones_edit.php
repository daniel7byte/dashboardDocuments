      ...
      <div class="container-fluid container-fh l-2column">
        ...
        <div class="m-content">
          ...
          <div class="page-content__header">
            <div>
              <h2 class="page-content__header-heading">Zonas</h2>
            </div>
          </div>
          ...
          <div class="container-fh__content">
            <div class="row">
              <div class="col-lg-12">
                <form class="main-container fl-form" method="POST" action="zones_edit_sql.php">
                  <input type="hidden" name="id" value="<?=$_GET['id']?>">
                  <div class="form-row">
                    <div class="form-group col-md-12">
                      <div class="fl-wrap fl-wrap-input">
                        <label for="title" class="fl-label">Zones</label>
