      ...
      <div class="container-fluid container-fh l-2column">
        ...
        <div class="m-content">
          ...
          <div class="container-fh__content">
            <div class="row">
              <div class="col-lg-12">
                <form class="main-container fl-form" method="POST" action="category_edit_sql.php">
                  <input type="hidden" name="id" value="<?=$_GET['id']?>">
                  <div class="form-row">
                    <div class="form-group col-md-12">
                      <div class="fl-wrap fl-wrap-input">
                        <label for="name" class="fl-label"><?=Name?></label>
                        <input type="text" class="form-control fl-input" id="name" name="name" placeholder="example" data-placeholder="example" required="required" value="<?=$name?>">
                      </div>
                    </div>
                  </div>
