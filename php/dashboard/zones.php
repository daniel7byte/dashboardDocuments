            ...
            <table id="datatable" class="table table-striped">
              ...
              <tbody>
                <?php
                  ...
                  $query = $mysql->prepare("SELECT * FROM zones ORDER BY id DESC");
                  $query->execute();
                  ...
                  <td>
                    <div class="dropdown card-widget-d__dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="zones_edit.php?id=<?=$row['id']?>">Editar</a>
                        <a class="dropdown-item" href="zones_delete_sql.php?id=<?=$row['id']?>">Eliminar</a>
                      </div>
                    </div>
                  </td>
                </tr>
