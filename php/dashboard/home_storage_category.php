<?php
  ...
  if (!isset($_GET['category'])) {
    header('Location: home_storage.php');
    exit;
  }
  ...
  $query = $mysql->prepare("SELECT name FROM category WHERE id = :id");
  $query->execute([':id' => $_GET['category']]);
      ...
      <div class="container-fluid container-fh">
        ...
        <div class="m-content">
          ...
          <div class="page-content__header">
            <div>
              <h2 class="page-content__header-heading"><?=DOCUMENTS?> (<?=$nameCat?>)</h2>
            </div>
          </div>
