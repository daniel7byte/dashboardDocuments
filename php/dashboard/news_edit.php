<?php
  ...
  $query = $mysql->prepare("SELECT * FROM news WHERE id = :id");
      ...
      <div class="container-fluid container-fh l-2column">
        ...
        <div class="m-content">
          ...
          <div class="container-fh__content">
            <div class="row">
              <div class="col-lg-12">
                <form class="main-container fl-form" method="POST" action="news_edit_sql.php">
                  <input type="hidden" name="id" value="<?=$_GET['id']?>">
                  <div class="form-row">
                    <div class="form-group col-md-12">
                      <div class="fl-wrap fl-wrap-input">
                        <label for="title" class="fl-label">Titulo</label>
                        <input type="text" class="form-control fl-input" id="title" name="title" placeholder="example" data-placeholder="example" required="required" value="<?=$title?>">
                      </div>
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="form-group col-md-12">
                      <div class="fl-wrap fl-wrap-input">
                        ...
                        <textarea class="form-control fl-input" name="description" id="description" required="required" placeholder="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do..."><?=$description?></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="form-group col-md-12">
                      <div class="fl-wrap fl-wrap-select"><label for="type" class="fl-label">Tipo</label>
                        <select required="required" id="type" name="type" class="form-control select2-hidden-accessible fl-select" tabindex="-1" aria-hidden="true">
                          <option selected="selected" value="<?=$type?>"><?=$type?> (ACTUAL)</option>
