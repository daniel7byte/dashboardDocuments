      ...
      <div class="container-fluid container-fh l-2column">
        ...
        <div class="m-content">
          ...
          <div class="page-content__header">
            <div>
              <h2 class="page-content__header-heading">Reporte de Lectura</h2>
            </div>
          </div>
            ...
            <table id="datatable" class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <?php
                      $queryUser = $mysql->prepare("SELECT * FROM users WHERE id = :id");
                      $queryUser->execute([':id' => $row['id_user']]);
                      $resultUser = $queryUser->fetchAll();

                      foreach ($resultUser as $rowUser):
                    ?>
                      <?=$rowUser['full_name']?> (<?=$rowUser['nick']?>)
                    <?php endforeach; ?>
